...
l1 = Like.create(user_id: 1, likeable_id: 1, likeable_type: 'Artwork')
l2 = Like.create(user_id: 2, likeable_id: 1, likeable_type: 'Artwork')
l3 = Like.create(user_id: 3, likeable_id: 2, likeable_type: 'Artwork')
l4 = Like.create(user_id: 4, likeable_id: 1, likeable_type: 'Comment')
l5 = Like.create(user_id: 1, likeable_id: 1, likeable_type: 'Comment')
l6 = Like.create(user_id: 2, likeable_id: 2, likeable_type: 'Comment')
